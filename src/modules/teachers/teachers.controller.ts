...
export class TeachersController {
  ...
  create(@Param('schoolId') schoolId: string, @Body() dto: CreateTeacherDto, @CurrentUser() user: AuthUser) {
    assertSchoolAccess(user, schoolId)
  ...
  createBulk(@Param('schoolId') schoolId: string, @Body() dto: BulkCreateTeachersDto, @CurrentUser() user: AuthUser) {
    assertSchoolAccess(user, schoolId)
  ...
  toggleStatus(@Param('id') id: string, @CurrentUser() user: AuthUser) {
    return this.teachersService.toggleStatus(id, user)
  }
